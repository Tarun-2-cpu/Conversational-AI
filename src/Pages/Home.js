    ...
    fetch(`${BASE_URL}/getAll`)
      ...
      .then((data) => {
        ...
        const systemMessageElement = (
          <tr
            key="system"
            className="sticky top-0 right-0 left-[100%] bg-slate-300 z-50 w-fit rounded-2xl" // Sticky and always at the top
          >
            <td
              className="relative p-4 mt-4 mb-4 rounded-[20px] text-xl text-[#212121] shadow-md shadow-black text-left font-semibold"
            >
              <div
              ...
              <button
                className="absolute top-2 right-[-25px] p-2 text-xl bg-transparent border-none cursor-pointer"
                onClick={toggle3}
                style={{ marginLeft: "8px", color: "white", fontSize: "25px" }}
              >
                &#x22EE; {/* Vertical ellipsis (three dots) */}
              </button>
            </td>
          ...
          return (
            ...
            >
              <td
                className={`relative p-4 mt-4 mb-4 rounded-[20px] text-xl ${
                  isPrimaryDesign
                    ? "bg-slate-300 text-[#212121] shadow-md shadow-black"
                    : "bg-black text-slate-300 shadow-md shadow-slate-300"
                } ${isLeft ? "text-left italic" : "text-left font-semibold"}`}
              >
                <div
                  dangerouslySetInnerHTML={{
      ...
      .then((data) => {
        ...
        const links = data.dir.map((folder, index) => (
          <div
            ...
            className="h-fit flex items-center justify-between py-2 px-3 mt-3 cursor-pointer hover:bg-slate-600 rounded-lg relative" // Added "relative" for positioning the dropdown
          >
            <div className="flex items-center justify-between gap-2">
              <button className="text-slate-300 text-xl font-semibold border-none text-center w-full">
                {folder}
              </button>
            </div>
            ...
            {drop === folder && (
              <div
                className=" bg-white shadow-md border rounded mt-2 z-10"
              ...
              >
                <ul className="py-1">
                  ...
                  <li
                    className="px-4 py-2 hover:bg-zinc-200 cursor-pointer"
                    onClick={() => {
                      alert(`Deleted: ${folder}`); // Delete functionality
                      setDrop(null); // Close dropdown
                    }}
                  >
                    Delete
    ...
    <div className=" h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="w-4/5 bg-zinc-700 h-screen">
          ...
          <div className="flex items-center justify-center gap-2 ">
              ...
              <Input
                  className="mb-3 p-2 px-4 py-3 w-9/12 rounded-full bg-zinc-600 text-yellow-50 focus:bg-zinc-200 focus:text-black  placeholder:text-zinc-200"
                  type="text"
              ...
              <Input
                  className="mb-3 w-fit px-5 py-3 bg-zinc-600 text-zinc-300 rounded-full"
                  type="button"
                  value="Submit"
                  id="submit_prompt"
