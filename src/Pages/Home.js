...
function Home() {
  ...
  function restore(suffix) {
    ...
    fetch(`${BASE_URL}/restore`, {
      ...
      const date = new Date();
      setSaveStatus('Restored - ' + date.toLocaleTimeString());  
      updateTable();
    });
  }
  ...
  return (
    <div className=" h-screen w-full flex items-center justify-center overflow-hidden">
      <div className="w-1/5 bg-zinc-900 h-screen overflow-y-auto no-scrollbar">
        <div class="sticky top-0 bg-zinc-900 z-50">
          <div className="h-fit flex items-center justify-between  xl:py-3 2xl:py-4 px-3">
              ...
              <button className="flex w-fit gap-2 items-center cursor-pointer" onClick={toggle4} title="Add File">
      ...
      <div className="w-4/5 bg-zinc-700 h-screen">
          <div className="h-fit flex justify-between items-center px-5 xl:py-3 2xl:py-4">
              ...
              <div className="flex items-center gap-10">
                  ...
                  <Dropdown className="" isOpen={dropdownOpen} toggle={toggle} direction="down" title="Chat settings">
                      <DropdownToggle
                          className="p-0 h-fit w-fit text-slate-300"
                          style={{
                              backgroundColor: 'transparent',
