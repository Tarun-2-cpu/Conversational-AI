      ...
      .then((data) => {
        ...
        const systemMessageElement = (
          <tr
           ...
           {/* bg-[#3f3f46] */}
            <td
              className="relative px-4 mt-0 mb-0 xl:text-base 2xl:text-xl text-[white] text-left font-semibold"
            >
              <div
    ...
    fetch(`${BASE_URL}/getStored`)
      ...
      .then((data) => {
        ...
        const links = data.dir.map((folder, index) => (
          <div
            key={index}
            onClick={() => submitStored(folder)} // Restore functionality on folder click
            className="h-fit flex items-center justify-between  py-2 px-3 xl:mt-2 2xl:mt-3 cursor-pointer hover:bg-slate-600 rounded-lg relative" // Added "relative" for positioning the dropdown
          >
            <div className="flex items-center justify-between gap-2">
              <button className="text-slate-300 xl:text-lg 2xl:text-xl font-semibold border-none text-center w-full">
                {folder}
              </button>
            </div>
        
            {/* Button with quill icon that toggles the dropdown */}
            <button
              ...
              type="button"
            >
              <i className="ri-quill-pen-line text-slate-300 xl:text-lg hover:xl:text-2xl 2xl:text-xl hover:2xl:text-3xl"></i>
            </button>
          </div>
        ));
  ...
  return (
    <div className=" h-screen w-full flex items-center justify-center overflow-hidden">
      <div className="w-1/5 bg-zinc-900 h-screen overflow-y-auto no-scrollbar">
        <div className="h-fit flex items-center justify-between  xl:py-3 2xl:py-4 px-3">
            <svg 
              width="30" 
              height="30" 
              viewBox="0 0 24 24" 
              ...
              className="icon-xl-heavy text-slate-300 hover:h-9 hover:w-9 cursor-pointer xl:h-6 xl:w-6 2xl:h-7 2xl:w-7">
            ...
            <button className="flex w-fit gap-2 items-center cursor-pointer" onClick={toggle4}>
                <Form className="flex w-fit gap-2 items-center cursor-pointer" inline onSubmit={(e) => e.preventDefault()}>
                    <i className="ri-add-line text-slate-300 xl:text-2xl  2xl:text-3xl hover:text-4xl cursor-pointer"></i>
                </Form>
            </button>
        ...
        <button className="h-fit w-full flex items-center py-2 px-3 cursor-pointer hover:bg-slate-600 border-b-2 border-slate-500" onClick={toggle4}>
            <Form className="flex w-full gap-2 justify-between items-center cursor-pointer" inline onSubmit={(e) => e.preventDefault()}>
                <div className="flex items-center justify-between gap-2">
                    ...
                    <p className="text-slate-300 xl:text-lg 2xl:text-xl font-semibold">Conversational AI</p>
                </div>
                <svg 
                 width="24"
                 height="24" 
                 ...
                 fill="currentColor" 
                 xmlns="http://www.w3.org/2000/svg" 
                 className="icon-xl-heavy text-slate-300 cursor-pointer xl:h-6 xl:w-6  hover:h-8 hover:w-8">
        ...
        <div className="history xl:mt-4" id="stored">
            {storedLinks} 

            {/* {drop && (
              <div
                className="absolute right-0 bg-white shadow-md border rounded mt-2 z-10"
                style={{ zIndex: 100, minWidth: '150px' }} // Inline styles for visibility
              >
                  <ul className="py-1">
                    <li 
                      className="px-4 py-2 hover:bg-zinc-200 cursor-pointer"
      ...
      <div className="w-4/5 bg-zinc-700 h-screen">
          <div className="h-fit flex justify-between items-center px-5 xl:py-3 2xl:py-4">
              ...
              <p id="save_status" className="text-zinc-200 font-bold xl:text-lg 2xl:text-xl">
                {saveStatus}
              </p>
              ...
              <div className="flex items-center gap-10">
                  ...
                  <Dropdown className="" isOpen={dropdownOpen} toggle={toggle} direction="down">
                      <DropdownToggle
                          ...
                          <i className="ri-more-2-fill xl:text-xl  2xl:text-2xl cursor-pointer hover:text-xl"></i>
                      </DropdownToggle>
                      <DropdownMenu className="bg-zinc-800 mt-2">
                          <DropdownItem className="text-center">
                              <button
                                  className="text-zinc-200 bg-transparent border-none w-full text-center hover:bg-zinc-700 hover:text-zinc-700 xl:py-1 2xl:py-2"
                                  onClick={() => save()}
                                  style={{
                                      backgroundColor: 'transparent',
                                      border: 'none',
          ...
          <div className="h-3/4 chat  overflow-y-scroll no-scrollbar xl:mb-4 2xl:mb-8"  id="table">
          ...
          <div className="flex items-center justify-center gap-2 ">
              ...
              <Input
                  className="mb-3 p-2 xl:px-3 xl:py-2 2xl:px-4 2xl:py-3 w-9/12 rounded-full bg-zinc-600 text-yellow-50 focus:bg-zinc-200 focus:text-black  placeholder:text-zinc-200"
                  type="text"
              ...
              <Input
                  className="mb-3 w-fit xl:px-3 xl:py-2 2xl:px-5 2xl:py-3 bg-zinc-600 text-zinc-300 rounded-full"
                  type="button"
                  value="Submit"
                  id="submit_prompt"
